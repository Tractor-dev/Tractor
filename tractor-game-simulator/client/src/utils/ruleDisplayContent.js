...
const TABLE_RULE_CONTENT_BY_NAME = Object.freeze({
  ...
  '第二战场': '每场公开5张公共牌，各家未参赛出牌跨轮累计；四家均至少5张时判定德州牌型，胜方+5分后换牌重开。若此时四家余牌都少于5张，则延至全部出完再判；王不参赛，五条高于同花顺，跨阵营并列相抵。',
  ...
  '记录在案': '一轮出现5、10、K、当前级牌或王时，下一轮显示记牌器一轮；显示轮若再次触发，则下一轮重新独立显示一轮。记牌器按实体花色和点数累计本局已出张数。',
