...
const RULE_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    name: '第二战场',
    content: '每场先公开5张公共牌。各家打出且尚未参赛的牌会明置在各自桌前并跨轮累计；只在轮末且四家均累计至少5张时由系统判定德州最佳牌型，胜者阵营获得5分，随后收走参赛牌、更换公共牌并重新累计。某场累计达到5张时，只有四家剩余手牌都严格少于5张才延至全部出完后进行最终判定；正好剩5张仍照常判定。王不参与牌型；双副牌的重复实体分别计算，五条高于同花顺；同阵营并列只奖励一次，跨阵营并列时双方各得5分。',
    setup: DEFAULT_RULE_SETUP
  }),
  Object.freeze({
